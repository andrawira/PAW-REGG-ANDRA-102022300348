...
$namaErr = $emailErr = $nimErr = $jurusanErr = $fakultasErr = "";
    ...
    // silakan taruh kode kalian di bawah
        ...
        if (empty($nama)) {
            ...
            $nimErr = "Isi nama menggunakan huruf";
        }
    ...
    // silakan taruh kode kalian di bawah
        ...
        if (empty($jurusanErr)) {
            $jurusanErr = "Masukkan jurusan anda";
        } elseif (!ctype_alpha($jurusan)) {
            $jurusanErr = "Isi jurusan menggunakan huruf";
        }
    ...
    $fakultas = $_POST["fakultas"];
        if (empty($fakultas)) {
            $fakultasErr = "Masukkan fakultas anda";
        } elseif (!ctype_alpha($fakultas)) {
            $fakultasErr = "Isi fakultas menggunakan huruf";
        }
    }
?>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th widht="20%">NIM</th>
                        <th widht="20%">Jurusan</th>
                        <th widht="20%">Fakultas</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
